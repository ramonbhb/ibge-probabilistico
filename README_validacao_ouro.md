...
- Esquerda: Censos da [`LISTA_OURO_AVALIACAO_ARQUIVO`](config.py) que existem em `censo_limpo` (`censo_ouro`). O 00b continua tirando só [`LISTA_OURO_ARQUIVO`](config.py) da aplicação.
