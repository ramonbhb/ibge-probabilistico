...
# COHORT_DIR, COHORT_DEDUP_ARQUIVO, LISTA_OURO_ARQUIVO,
# LISTA_OURO_AVALIACAO_ARQUIVO, DUCKDB_TEMP_DIR,
...
# Só o 03b. O 00/00b continuam em LISTA_OURO_ARQUIVO (exclusão da aplicação).
LISTA_OURO_AVALIACAO_ARQUIVO = Path(
    os.environ.get(
        "LISTA_OURO_AVALIACAO_ARQUIVO",
        LISTA_OURO_ARQUIVO.parent / "regra_avaliacao.parquet",
    )
).expanduser()
